...
**Product:** Club marketing tool for outreach: club collaborations and sponsor partnerships.
...
├── lib/
│   └── utils.ts              # cn() and utilities (shadcn)
├── components/
...
│   ├── Sponsors.tsx          # Sponsor outreach management
...
- Home dashboard
- Outreach (expandable): Clubs (club collaboration), Sponsors (sponsorship outreach)
- AI advisor
- Settings
